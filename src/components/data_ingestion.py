...
# initialize the data ingestion configuration (Here all the paths of data ingestion class are defined)
@dataclass
# @dataclass is used to make quickly class variable and because of this we have to not make initialization constructor
